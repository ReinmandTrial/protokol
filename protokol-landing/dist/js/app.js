 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".examples__slider")) new core(".examples__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".documents__slider")) {
                const docSLider = new core(".documents__slider", {
...
***************************************************************************** */
        ...
        }
        {
            ...
            function initDocumenent() {
                if (cueAmountDoc <= 5) hiddenDocBtn();
                replaceAllDocNum();
                nowSeeDocEl();
                renderInit();
            }
            ...
            function replaceAllDocNum() {
                if (0 !== cueAmountDoc) counterDocAll.textContent = cueAmountDoc;
            }
            function renderInit() {
                if (cueAmountDoc >= 5) for (let i = 0; 5 !== i; i++) {
                    const el = docArrImgEL[i];
                    el.classList.add("_active");
                }
                if (cueAmountDoc < 5) for (let i = 0; i !== cueAmountDoc; i++) {
                    const el = docArrImgEL[i];
                    el.classList.add("_active");
                }
                nowSeeDocEl();
            ...
            function renameBtn(val) {
                if (1 === val) docMoreBtn.textContent = "Дивитися всі документи";
                if (2 === val) docMoreBtn.textContent = "Закрыть список";
            }
        }
        {
            ...
            function initPublic() {
                if (publicItemElLength <= 6) hidenPublicBtn();
                renderStartPublic();
                totalPublicEl();
                nowSeePublEl();
            }
            function renderStartPublic() {
                if (publicItemElLength >= 6) for (let i = 0; 6 !== i; i++) {
                    const el = publicAllItemEl[i];
                    el.classList.add("_active");
                }
                if (publicItemElLength < 6) for (let i = 0; i !== publicItemElLength; i++) {
                    const el = publicAllItemEl[i];
                    el.classList.add("_active");
                }
            }
            ...
            function totalPublicEl() {
                if (0 !== publicItemElLength) counterPublicTotal.textContent = publicItemElLength;
            }
        ...
        }
        {
            ...
            function initRewiew() {
                if (rewiewItemElLength <= 4) hidenReviewBtn();
                renderStartReview();
            }
            function renderStartReview() {
                if (rewiewItemElLength >= 4) for (let i = 0; 4 !== i; i++) {
                    const el = rewiewAllItemEl[i];
                    el.classList.add("_active");
                }
                if (rewiewItemElLength < 4) for (let i = 0; i !== rewiewItemElLength; i++) {
                    const el = rewiewAllItemEl[i];
                    el.classList.add("_active");
                }
            }
            function openNextRewiewStep() {
                ...
                if (needRender < rewiewItemElLength) for (let i = nowSee; i !== needRender; i++) {
                    console.log("dsfdsf");
                    const el = rewiewAllItemEl[i];
                    el.classList.add("_active");
                }
